<x-app-layout>
    ...
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-2xl font-bold text-white mb-6">Edit Booking </h1>
        ...
        <select id="user_id" name="user_id" class="mt-2 block w-full rounded-md border-gray-300 shadow-sm">
        ...
        @enderror
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="room_type_id" name="room_type_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            <option value="">Select Room Type</option>
                            @foreach($roomTypes as $roomType)
                                <option value="{{ $roomType->id }}"
                                    {{ $booking->room->room_type_id == $roomType->id ? 'selected' : '' }}>
